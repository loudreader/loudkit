...
WAVs saved from Python and the server's replies carry unsigned C2PA Content
Credentials by default, naming the model, voice, seed and backend; the Go,
Rust, JS and Swift ports write plain PCM.
