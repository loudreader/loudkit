...
- `loudkit serve`: an HTTP server with loudkit's own routes and an
  ...
  Agents that speak OpenAI's speech API, Hermes Agent and OpenClaw among them,
  [connect with configuration alone](https://github.com/loudreader/loudkit/blob/main/docs/guides/04-server-and-agents.md#connect-your-agent).
