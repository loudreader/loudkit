...
Measurement, evaluation and benchmarking scripts. Nothing here is needed to
install, run or release loudkit: `tools/` holds what builds the shipped
artifacts, and this directory holds what argues about them.
