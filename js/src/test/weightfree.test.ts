...
test("seed derivation matches the fixture", () => {
  // The shipping function, not a second copy of its formula: a test that
  // declares PHI and PSI itself stays green when the constants `Engine`
  // actually uses change.
