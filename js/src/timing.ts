 ...
 * hold NEL, so `ab<NEL>c` was one word here and two everywhere else: a
 * differently placed highlight for the same reading. Written out rather than
 * imported from the funnel so this module keeps its foundation layer, the same
 * rule `loudkit.timing` follows.
 */
const WHITE_SPACE = "\u0009\u000a\u000b\u000c\u000d\u0020\u0085\u00a0\u1680\u2000-\u200a\u2028\u2029\u202f\u205f\u3000";
