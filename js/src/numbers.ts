 ...
 * character there is. With `\w`, `é2` reads as *étwo* here and stays written
 * in the other four.
 *
 ...
 * Everything downstream reads the sign as `-`, so unfolded, a typographic
 * minus is not a sign at all: it reaches the punctuation pass, becomes a
 * space, and `−5` reads as *five*. Not U+2013, which writes a range.
 */
