...
//! different part of `numbers.json`, and each used to embed and parse the whole
//! file for itself: three `include_str!`s of the same 55 kB and three
//! `serde_json` passes over it, the second and third thrown away as soon as the
//! block they wanted was copied out. This module is the one locator and the one
//! parse, and it is a leaf: it knows nothing about numbers, dates or letters,
//! so the three passes depend on the data and not on each other.
//!
