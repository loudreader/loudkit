...
///
/// `synthesize` renders one window (~127 characters of prepared text) and
/// refuses anything longer, so the long-form path is what a caller with a
/// paragraph goes through. A caller splitting for themselves gets different
