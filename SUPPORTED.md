...
- **Content Credentials**: a WAV saved from Python and every server reply
  carries an unsigned C2PA claim naming the algorithm, checkpoint, voice
  profile, backend and seed; the Go, Rust, JS and Swift ports write plain PCM.
