...
// outside this package. The two justifications that stood here and on
// the exported name, both about a CLI copy of the chain and about Encode, are
// retracted: cmd/loudkit calls neither function, it calls Synthesize and lets
// the engine resolve.
