...
var (
	...
	// With `\s` this port would keep the NBSP that French typography puts
	// before ! ? ; : and the frontend would fold it to a plain space, one
	// extra token per mark and a different token count from the other four.
